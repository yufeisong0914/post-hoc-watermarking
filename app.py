...
def flask_hello_world():
    return 'please input get_candidates'


@app.route('/get_candidates', methods=['GET', 'POST'])
def get_candidates():
    # prefix: str, complex_word: str, suffix: str
    ...
    substitutes = lexical_substitute_transformer_model(text, prefix, target, suffix, args["beam"])
    print(substitutes)
    r = {"substitutes": substitutes}
    return r


def give_real_scores_ahead(
...
def lexical_substitute_transformer_model(ori_sen, prefix, mask_word, suffix, beam):
    # 将原句编码
...
if __name__ == "__main__":
    args = {
        ...
        'paraphraser_path': '/home/haojifei/develop_tools/my_models/parals-checkpoints/para/transformer/',
