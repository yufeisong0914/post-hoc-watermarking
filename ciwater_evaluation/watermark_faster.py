...
class watermark_model:
    ...
    def paragraph_tokenize(self, paragraph):
        ...
        if self.language == 'Chinese':
            ...
            paragraph = ciwater_util_string.preprocess_string(paragraph)  # 预处理一下
    ...
    def embed(self, paragraph):
        ...
        watermarked_text = ciwater_util_string.preprocess_string(watermarked_text)
    ...
    def watermark_embed_v1(self, text):
        ...
        for i in mask_words_index_new:
            ...
            good_candidates_index = self.token_detectable_filter(good_candidates_index, candidates, doc_sentence, i)
    ...
    def candidates_gen_v1(self, doc_sentence, mask_word_index):
        ...
        prefix_s = ciwater_util_string.preprocess_string(prefix_s)  # 处理句子前缀
        ...
        suffix_s = ciwater_util_string.preprocess_string(suffix_s)  # 处理句子后缀
    ...
    def token_detectable_filter(self, good_candidates_index, candidates, doc_sentence, i):
        ...
        for index in good_candidates_index:
            ...
            temp_sentence = ciwater_util_string.preprocess_string(temp_sentence)
